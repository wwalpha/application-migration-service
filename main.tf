...
module "app" {
  source               = "./app"
  prefix               = local.prefix
  vpc_id               = module.networking.vpc_id_src
  private_subnets      = module.networking.private_subnet_ids_src
  iam_role_profile_ec2 = module.security.iam_role_profile_ec2_mgn
}
